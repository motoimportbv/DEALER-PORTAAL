...
### P0 - Afgerond
- **Import-context in AI onderbouwing voor motorfietsen** (Feb 2026): `bpm_ai.py` voegt voor `vehicle_type=motorfiets` automatisch een verplichte alinea toe over de waardedrukkende invloed van import-status. AI verwerkt: logistieke/transportkosten buitenland, RDW-keuring + Nederlandse spec aanpassingen, ontbreken Nederlandse onderhoudshistorie + garantieverlies, marktverhouding (10-20% lager dan NL exemplaren), wettelijke basis (art. 10 lid 7 Wet BPM + Hoge Raad ECLI:NL:HR:2014:80). Tekst voor motorfietsen nu 350-500 woorden (was 250-400). Auto's krijgen géén import-context (Deniz' workflow is lokale taxatie).
