...
### P0 - Afgerond
- **AI prompt verrijking met regelitems** (Feb 2026): `bpm_ai.py` verzendt nu `hours` + `material_cost` per damage-item naar Claude. AI verwerkt deze in zinnen als "2,5 uur arbeid (€162) plus €258 materiaal = €420 totaal". Lengte verhoogd naar 250-400 woorden voor diepere onderbouwing.
