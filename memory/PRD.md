...
### P0 - Afgerond
- **AutoTelex Invul Helper** (Feb 2026): Nieuwe sectie in BPM Terugreken-kaart waar admin de inkoopprijs (van factuur) + overig waardeverminderingsbedrag invult. Het systeem berekent direct welke 4 waarden in AutoTelex moeten (Handelsinkoop / Schade / Percentage / Overig) om bij gegeven Inkoop op de gewenste rest-BPM uit te komen. Met **"Kopieer waarden"** knop voor direct plakken in AutoTelex.
