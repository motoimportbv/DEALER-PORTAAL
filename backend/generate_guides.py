...
def create_dealer_guide_nl():
    ...
    story.append(Paragraph("https://moto-import-dealer-1.preview.emergentagent.com/register", styles['URLStyle']))
...
def create_supplier_guide_nl():
    ...
    story.append(Spacer(1, 10))
    story.append(Paragraph("Registratie URL:", styles['GuideBodyText']))
    story.append(Paragraph("https://moto-import-dealer-1.preview.emergentagent.com/register/supplier", styles['URLStyle']))
