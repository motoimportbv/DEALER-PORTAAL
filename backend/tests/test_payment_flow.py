...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://dealercatalog-app.preview.emergentagent.com')
    ...
    def test_create_checkout_session_without_delivery(self, dealer_token):
        ...
        response = requests.post(
            ...
            json={
                ...
                "order_type": "buy_now",
                "origin_url": "https://dealercatalog-app.preview.emergentagent.com"
            }
        )
