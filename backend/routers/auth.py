...
# Alle auth-gerelateerde endpoints
...
from services import (
    ...
    create_notification_token, create_permanent_login_token,
    get_current_user, generate_short_code, send_email, send_admin_notification
)
from models import (
    UserCreate, SupplierCreate, UserLogin,
...
@router.post("/notification-login")
...
@router.post("/generate-permanent-link")
...
@router.post("/revoke-permanent-link")
